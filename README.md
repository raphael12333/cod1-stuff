# Various stuff for [CoD1](https://en.wikipedia.org/wiki/Call_of_Duty_(video_game)) Multiplayer
### Notes
...
- *gravity_tubes* requires CoDaM and [iw1x-server](https://github.com/raphael12333/iw1x-server)
___
#### References
